...
export const themePresets: Record<ThemePresetId, ThemePreset> = {
  ...
  'esi-fairytale': {
    ...
    gameTheme: {
      millionaire: {
        containerGradient: 'linear-gradient(to bottom, #2b2b2b, #1a1a1a)',
        moneyLadderBackground: '#1a1a1a',
        questionBackground: 'linear-gradient(to right, #3d3d3d, #2b2b2b)',
        lifelineBackground: '#2b2b2b',
        accentColor: '#d4af37'
      },
      bingo: {
        containerGradient: 'linear-gradient(to bottom, #2b2b2b, #1a1a1a)',
        cardBackground: 'rgba(201, 168, 108, 0.1)',
        markedCellColor: '#4a9f64',
        winHighlight: '#d4af37'
      },
      speedRound: {
        containerGradient: 'linear-gradient(to bottom, #2b2b2b, #1a1a1a)',
        timerBackground: 'rgba(0, 0, 0, 0.5)',
        questionBackground: 'rgba(43, 43, 43, 0.95)',
        urgentColor: '#c45c5c'
      },
      spotDifference: {
        containerBackground: '#1a1a1a',
        documentBackground: '#2b2b2b',
        highlightColor: 'rgba(212, 175, 55, 0.3)',
        foundColor: 'rgba(74, 159, 100, 0.3)'
      }
    },
    effects: {
      borderRadius: 'small',
